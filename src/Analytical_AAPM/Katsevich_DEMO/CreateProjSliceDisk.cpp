...
static const double PhPar[7][8] = {
{0.70,  0.70,  0.06, 0, 0, -0.66,  0, 1.0},
{0.70,  0.70,  0.06, 0, 0, -0.44,  0, 1.0},
{0.70,  0.70,  0.06, 0, 0, -0.22,  0, 1.0},
{0.70,  0.70,  0.06, 0, 0,  0.00,  0, 1.0},
{0.70,  0.70,  0.06, 0, 0,  0.22,  0, 1.0},
{0.70,  0.70,  0.06, 0, 0,  0.44,  0, 1.0},
{0.70,  0.70,  0.06, 0, 0,  0.66,  0, 1.0}};
...
mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	else 
	{
		...
		XS[1] = pou*sintheta;
		XS[2] = z_heigh;
		for (ElpIndex=0;ElpIndex<7;ElpIndex++)
		{
