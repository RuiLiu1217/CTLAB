...
// \brief Equal Distance DD Backprojection in Cone Beam Geometry
// \param proj projection data
...
// \brief Equal Angular DD Backprojection in Cone Beam Geometry
// \param proj projection data
// \param vol image volume
// \param S2O source to object distance
// \param O2D object to detector distance
...
// \brief Equal Angular DD Backprojection in Helical Beam Geometry
// \param proj projection data
// \param vol image volume
// \param S2O source to object distance
// \param O2D object to detector distance
